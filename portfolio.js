  ...
  data: [
    {
      ...
      skills: [
        ...
        emoji(
          "⚡ extensive experience in the full life cycle of the software design and implementation process including requirements definition, prototyping, and proof of concept, design, interface implementation, testing, maintenance and technical leadership."
        ),
        emoji(
    ...
    },
    {
      ...
      skills: [
        ...
        emoji("⚡ Hosting and maintaining application on Google Play."),
        emoji(
    ...
    },
    {
      ...
      skills: [
        emoji("⚡ Experience in developing web applications using Node Js"),
        emoji(
...
export const experience = [
  {
    ...
    companylogo: "/img/icons/common/agoda.png",
    date: "Sep 2022",
    desc: "In my current position at Agoda, I serve as a Lead Engineer for mobile. In this capacity, my responsibilities encompass the design of the overall system architecture and providing support to existing legacy systems. Additionally, I lead a team in the development of distinct modules, adhering to the Agile Scrum methodology with two-week sprint cycles.",
    // descBullets: [
  ...
  {
    role: "Lead Mobile Engineer",
    company: "Charles Schwab USA - Consultant",
    companylogo: "/img/icons/common/charles_schwab_logo.jpeg",
    date: "January 2021 - December 2021",
    desc: "As a Lead Software Engineer at Charles Schwab, my role involves crucial responsibilities in team management and providing a comprehensive architectural perspective. Leading a team of adept professionals, I actively contribute to the strategic design and implementation of robust software solutions.",
    // descBullets: [
    // 	"Lorem ipsum dolor sit amet, consdfgectetur adipiscing elit",
    // 	"Lorem ipsum dolor sit amet, consectetur adipiscing elit",
    // ],
  ...
  {
    role: "Lead Mobile Engineer",
    company: "TD Bank USA - Consultant",
    companylogo: "/img/icons/common/td.png",
    date: "May 2022 - December 2022",
    desc: "In my role as Lead Software Engineer at TD Bank, I assume a key responsibility in managing teams and offering a comprehensive architectural perspective. Leading a group of skilled professionals, I actively contribute to the strategic design and implementation of resilient software solutions.		",
    // descBullets: [
    // 	"Lorem ipsum dolor sit amet, consdfgectetur adipiscing elit",
    // 	"Lorem ipsum dolor sit amet, consectetur adipiscing elit",
    // ],
  },
  {
    ...
    company: "Ailaaj",
    companylogo: "/img/icons/common/ailaaj_logo.png",
    date: "May 2022 - Sep 2022",
    desc: "While at Ailaaj, I held the position of Engineering Manager for mobile. In this capacity, my responsibilities included designing the overall system architecture, providing support to existing legacy systems, and leading the team in the development of distinct modules. This process followed the Agile Scrum methodology, with emphasis on two-week sprint cycles.",
    // descBullets: [
    // 	"Lorem ipsum dolor sit amet, consdfgectetur adipiscing elit",
    // 	"Lorem ipsum dolor sit amet, consectetur adipiscing elit",
    // ],
  },
  {
    ...
    desc: "During my tenure at Digitify, I served as the Principal Android Application Developer. In this role, my responsibilities included breaking down the entire project into modules prior to commencement, establishing the overarching project architecture, and subsequently guiding the team in developing individual modules. This process adhered to the Agile Scrum methodology, emphasizing two-week sprint cycles.",
    // descBullets: [
    // 	"Lorem ipsum dolor sit amet, consdfgectetur adipiscing elit",
    // 	"Lorem ipsum dolor sit amet, consectetur adipiscing elit",
    // ],
...
export const projects = [
  {
    name: "Agoda - Travel & Local",
    desc: "Even lower prices than our own website! The Agoda app is your best tool for finding and booking the very best deals on any kind of accommodation or flights, anywhere in the world..",
    link: "https://play.google.com/store/apps/details?id=com.agoda.mobile.consumer",
  },
  {
  ...
  {
    name: "Ailaaj -Speak to Online Doctor",
    desc: "Are you looking for an app that takes care of all your healthcare needs in one place? With Ailaaj, you’re able to speak to a doctor instantly, book your lab tests, & have your medicines delivered right to you.",
    link: "https://play.google.com/store/apps/details?id=com.augmentcare.patient",
  },
  {
    name: "iInvest by Integrated",
    desc: "iInvest allows people to analyze and trade financial instruments in different exchanges. View real-time market data, analyze market and instruments with easy-to-follow tools, place orders with a few taps, and evaluate your portfolio and useful stats. It helps people Trading & Brokerage.",
    link: "https://play.google.com/store/apps/details?id=com.wave.iInvest",
  },
  {
    name: "Xplora",
